...
$url        = 'https://camwebapp.com/download/cam' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'CAM' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique

  # Checksums are now required as of 0.10.0.
  # To determine checksums, you can get that from the original site if provided. 
  # You can also use checksum.exe (choco install checksum) and use it 
  # e.g. checksum -t sha256 -f path\to\file
  checksum      = '8EE9842D5CBA2D4D5B08411F1D6B8491774F759B55EBF1FC29517B7CE6A8D7B2'
  ...
  silentArgs	= '/exenoui /exelang 1033 /exenoupdates'
  #silentArgs   = '/S'           # NSIS
